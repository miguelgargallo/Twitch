...
var require_warn_once = __commonJS({
  "../../node_modules/next/dist/shared/lib/utils/warn-once.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      ...
      exports.warnOnce = warnOnce2 = (msg) => {
        if (!warnings.has(msg)) {
          console.warn(msg);
        }
        warnings.add(msg);
...
var require_head = __commonJS({
  "../../node_modules/next/dist/shared/lib/head.js"(exports, module2) {
    ...
    function reduceComponents(headChildrenElements, props) {
      ...
      return headChildrenElements.reduce(onlyReactElement, []).reverse().concat(defaultHead(inAmpMode).reverse()).filter(unique()).reverse().map((c2, i2) => {
        const key = c2.key || i2;
        if (process.env.NODE_ENV !== "development" && process.env.__NEXT_OPTIMIZE_FONTS && !inAmpMode) {
          if (c2.type === "link" && c2.props["href"] && [
            "https://fonts.googleapis.com/css",
            "https://use.typekit.net/"
          ].some((url) => c2.props["href"].startsWith(url))) {
            const newProps = _extends({}, c2.props || {});
...
var require_image_config_context = __commonJS({
  "../../node_modules/next/dist/shared/lib/image-config-context.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_micromatch = __commonJS({
  "../../node_modules/next/dist/compiled/micromatch/index.js"(exports, module2) {
    (() => {
      "use strict";
      var e = { 333: (e2, t2, r2) => {
        const n = r2(137);
        ...
        const compile = (e3, t3 = {}) => {
          let walk = (e4, r3 = {}) => {
            ...
            if (e4.type === "open") {
              return i2 ? a + e4.value : "(";
            }
            if (e4.type === "close") {
              return i2 ? a + e4.value : ")";
            }
            if (e4.type === "comma") {
              return e4.prev.type === "comma" ? "" : i2 ? e4.value : "|";
            }
            if (e4.value) {
              return e4.value;
            }
        ...
        const expand = (e3, t3 = {}) => {
          ...
          let walk = (e4, o = {}) => {
            ...
            let i2 = o;
            let a = o.queue;
            while (i2.type !== "brace" && i2.type !== "root" && i2.parent) {
              i2 = i2.parent;
              a = i2.queue;
            }
            ...
            for (let t4 = 0; t4 < e4.nodes.length; t4++) {
              ...
              if (r4.type === "close") {
                a.push(append(a.pop(), c2, l));
                continue;
              }
              if (r4.value && r4.type !== "open") {
                c2.push(append(c2.pop(), r4.value));
                continue;
              }
              if (r4.nodes) {
                walk(r4, e4);
        ...
        const n = r2(137);
        const { MAX_LENGTH: u, CHAR_BACKSLASH: s, CHAR_BACKTICK: o, CHAR_COMMA: i2, CHAR_DOT: a, CHAR_LEFT_PARENTHESES: l, CHAR_RIGHT_PARENTHESES: c2, CHAR_LEFT_CURLY_BRACE: p2, CHAR_RIGHT_CURLY_BRACE: f2, CHAR_LEFT_SQUARE_BRACKET: A, CHAR_RIGHT_SQUARE_BRACKET: R, CHAR_DOUBLE_QUOTE: _, CHAR_SINGLE_QUOTE: h, CHAR_NO_BREAK_SPACE: g2, CHAR_ZERO_WIDTH_NOBREAK_SPACE: E } = r2(457);
        const parse2 = (e3, t3 = {}) => {
          if (typeof e3 !== "string") {
        ...
        t2.exceedsLimit = (e3, r2, n = 1, u) => {
          if (u === false)
            return false;
          if (!t2.isInteger(e3) || !t2.isInteger(r2))
            return false;
        ...
        const isNumber2 = (e3) => Number.isInteger(+e3);
        const zeros = (e3) => {
          let t3 = `${e3}`;
          let r3 = -1;
          if (t3[0] === "-")
        ...
        const fillNumbers = (e3, t3, r3 = 1, n2 = {}) => {
          ...
          let c2 = zeros(i2) || zeros(a) || zeros(l);
          let p2 = c2 ? Math.max(i2.length, a.length, l.length) : 0;
          let f2 = c2 === false && stringify(e3, t3, n2) === false;
          let A = n2.transform || transform(f2);
          if (n2.toRegex && r3 === 1) {
            return toRange(toMaxLen(e3, p2), toMaxLen(t3, p2), true, n2);
          }
        ...
        const fillLetters = (e3, t3, r3 = 1, n2 = {}) => {
          if (!isNumber2(e3) && e3.length > 1 || !isNumber2(t3) && t3.length > 1) {
          ...
          if (n2.toRegex === true) {
            return toRegex(c2, null, { wrap: false, options: n2 });
          }
          return c2;
        };
        const fill = (e3, t3, r3, n2 = {}) => {
          ...
          if (!isNumber2(r3)) {
            if (r3 != null && !isObject(r3))
              return invalidStep(r3, u2);
            return fill(e3, t3, 1, r3);
          }
          if (isNumber2(e3) && isNumber2(t3)) {
        ...
        micromatch.capture = (e3, t3, r3) => {
          ...
          let i2 = u2.exec(n2 ? o.toPosixSlashes(t3) : t3);
          if (i2) {
            return i2.slice(1).map((e4) => e4 === void 0 ? "" : e4);
          }
        };
        ...
        const C = `[^.${l}]`;
        const y = `${p2}*?`;
        const d2 = { DOT_LITERAL: o, PLUS_LITERAL: i2, QMARK_LITERAL: a, SLASH_LITERAL: l, ONE_CHAR: c2, QMARK: p2, END_ANCHOR: f2, DOTS_SLASH: R, NO_DOT: _, NO_DOTS: h, NO_DOT_SLASH: g2, NO_DOTS_SLASH: E, QMARK_NO_DOT: C, STAR: y, START_ANCHOR: A };
        const x = __spreadProps(__spreadValues({}, d2), { SLASH_LITERAL: `[${u}]`, QMARK: s, STAR: `${s}*?`, DOTS_SLASH: `${o}{1,2}(?:[${u}]|$)`, NO_DOT: `(?!${o})`, NO_DOTS: `(?!(?:^|[${u}])${o}{1,2}(?:[${u}]|$))`, NO_DOT_SLASH: `(?!${o}{0,1}(?:[${u}]|$))`, NO_DOTS_SLASH: `(?!${o}{1,2}(?:[${u}]|$))`, QMARK_NO_DOT: `[^.${u}]`, START_ANCHOR: `(?:^|[${u}])`, END_ANCHOR: `(?:[${u}]|$)` });
        ...
        const n = r2(356);
        const u = r2(513);
        const { MAX_LENGTH: s, POSIX_REGEX_SOURCE: o, REGEX_NON_SPECIAL_CHARS: i2, REGEX_SPECIAL_CHARS_BACKREF: a, REPLACEMENTS: l } = n;
        ...
        const parse2 = (e3, t3) => {
          ...
          const c2 = typeof r3.maxLength === "number" ? Math.min(s, r3.maxLength) : s;
          let p2 = e3.length;
          if (p2 > c2) {
            throw new SyntaxError(`Input length: ${p2}, exceeds maximum allowed length: ${c2}`);
          }
          const f2 = { type: "bos", value: "", output: r3.prepend || "" };
          const A = [f2];
          const R = r3.capture ? "" : "?:";
          const _ = u.isWindows(t3);
          const h = n.globChars(_);
          const g2 = n.extglobChars(h);
          const { DOT_LITERAL: E, PLUS_LITERAL: C, SLASH_LITERAL: y, ONE_CHAR: d2, DOTS_SLASH: x, NO_DOT: b, NO_DOT_SLASH: S, NO_DOTS_SLASH: H, QMARK: v, QMARK_NO_DOT: $, STAR: m, START_ANCHOR: T } = h;
          ...
          const push = (e4) => {
            if (P.type === "globstar") {
              ...
              const r4 = e4.extglob === true || k2.length && (e4.type === "pipe" || e4.type === "paren");
            ...
            if (k2.length && e4.type !== "paren" && !g2[e4.value]) {
              k2[k2.length - 1].inner += e4.value;
            }
            if (e4.value || e4.output)
              append(e4);
          ...
          const extglobOpen = (e4, t4) => {
            const n2 = __spreadProps(__spreadValues({}, g2[t4]), { conditions: 1, inner: "" });
            n2.prev = P;
            n2.parens = N.parens;
            n2.output = N.output;
            const u2 = (r3.capture ? "(" : "") + n2.open;
            increment("parens");
            push({ type: e4, value: t4, output: N.output ? "" : d2 });
          ...
          while (!eos()) {
            ...
            if (P.type === "star") {
              ...
              const i3 = N.braces > 0 && (n3.type === "comma" || n3.type === "brace");
              const a2 = k2.length && (n3.type === "pipe" || n3.type === "paren");
              if (!s2 && n3.type !== "paren" && !i3 && !a2) {
                push({ type: "star", value: B, output: "" });
                continue;
              }
              while (t4.slice(0, 3) === "/**") {
        ...
        parse2.fastpaths = (e3, t3) => {
          const r3 = __spreadValues({}, t3);
          const o2 = typeof r3.maxLength === "number" ? Math.min(s, r3.maxLength) : s;
          const i3 = e3.length;
          if (i3 > o2) {
            throw new SyntaxError(`Input length: ${i3}, exceeds maximum allowed length: ${o2}`);
          }
          e3 = l[e3] || e3;
          const a2 = u.isWindows(t3);
          const { DOT_LITERAL: c2, SLASH_LITERAL: p2, ONE_CHAR: f2, DOTS_SLASH: A, NO_DOT: R, NO_DOTS: _, NO_DOTS_SLASH: h, STAR: g2, START_ANCHOR: E } = n.globChars(a2);
          const C = r3.dot ? _ : R;
          const y = r3.dot ? h : R;
          const d2 = r3.capture ? "" : "?:";
          const x = { negated: false, prefix: "" };
          let b = r3.bash === true ? ".*?" : g2;
          if (r3.capture) {
            b = `(${b})`;
          }
          const globstar = (e4) => {
            if (e4.noglobstar === true)
              return b;
            return `(${d2}(?:(?!${E}${e4.dot ? A : c2}).)*?)`;
          };
          const create = (e4) => {
            switch (e4) {
              case "*":
              ...
              case "*.*":
                return `${C}${b}${c2}${f2}${b}`;
              case "*/*":
                return `${C}${b}${p2}${f2}${y}${b}`;
              case "**":
                return C + globstar(r3);
              case "**/*":
                return `(?:${C}${globstar(r3)}${p2})?${y}${f2}${b}`;
              case "**/*.*":
                return `(?:${C}${globstar(r3)}${p2})?${y}${b}${c2}${f2}${b}`;
              case "**/.*":
                return `(?:${C}${globstar(r3)}${p2})?${c2}${f2}${b}`;
              default: {
                const t4 = /^(.*?)\.(\w+)$/.exec(e4);
                if (!t4)
                  return;
        ...
        const picomatch = (e3, t3, r3 = false) => {
          ...
          const i3 = n2 ? picomatch.compileRe(e3, t3) : picomatch.makeRe(e3, t3, false, true);
          const a = i3.state;
          delete i3.state;
          let isIgnored = () => false;
          if (u2.ignore) {
          ...
          const matcher = (r4, n3 = false) => {
            const { isMatch: o2, match: l, output: c2 } = picomatch.test(r4, i3, t3, { glob: e3, posix: s2 });
            const p2 = { glob: e3, state: a, regex: i3, posix: s2, input: r4, output: c2, match: l, isMatch: o2 };
        ...
        picomatch.test = (e3, t3, r3, { glob: n2, posix: u2 } = {}) => {
          ...
          const s2 = r3 || {};
          const i3 = s2.format || (u2 ? o.toPosixSlashes : null);
          let a = e3 === n2;
          let l = a && i3 ? i3(e3) : e3;
          if (a === false) {
            l = i3 ? i3(e3) : e3;
        ...
        picomatch.parse = (e3, t3) => {
          if (Array.isArray(e3))
            return e3.map((e4) => picomatch.parse(e4, t3));
        ...
        picomatch.compileRe = (e3, t3, r3 = false, n2 = false) => {
          ...
          let i3 = `${s2}(?:${e3.output})${o2}`;
          if (e3 && e3.negated === true) {
            i3 = `^(?!${i3}).*$`;
          }
          const a = picomatch.toRegex(i3, t3);
          if (n2 === true) {
            a.state = e3;
          }
          return a;
        ...
        picomatch.constants = i2;
        e2.exports = picomatch;
      }, 700: (e2, t2, r2) => {
        const n = r2(513);
        const { CHAR_ASTERISK: u, CHAR_AT: s, CHAR_BACKWARD_SLASH: o, CHAR_COMMA: i2, CHAR_DOT: a, CHAR_EXCLAMATION_MARK: l, CHAR_FORWARD_SLASH: c2, CHAR_LEFT_CURLY_BRACE: p2, CHAR_LEFT_PARENTHESES: f2, CHAR_LEFT_SQUARE_BRACKET: A, CHAR_PLUS: R, CHAR_QUESTION_MARK: _, CHAR_RIGHT_CURLY_BRACE: h, CHAR_RIGHT_PARENTHESES: g2, CHAR_RIGHT_SQUARE_BRACKET: E } = r2(356);
        const isPathSeparator = (e3) => e3 === c2 || e3 === o;
        const depth = (e3) => {
          if (e3.isPrefix !== true) {
        ...
        const { REGEX_BACKSLASH: s, REGEX_REMOVE_BACKSLASH: o, REGEX_SPECIAL_CHARS: i2, REGEX_SPECIAL_CHARS_GLOBAL: a } = r2(356);
        t2.isObject = (e3) => e3 !== null && typeof e3 === "object" && !Array.isArray(e3);
        t2.hasRegexChars = (e3) => i2.test(e3);
        ...
        t2.escapeLast = (e3, r3, n2) => {
          ...
          if (u2 === -1)
            return e3;
          if (e3[u2 - 1] === "\\")
            return t2.escapeLast(e3, r3, u2 - 1);
        ...
        const toRegexRange = (e3, t3, r3) => {
          ...
          let i2 = String(u.capture);
          let a = String(u.wrap);
          let l = e3 + ":" + t3 + "=" + s + o + i2 + a;
          if (toRegexRange.cache.hasOwnProperty(l)) {
            return toRegexRange.cache[l].result;
          }
          let c2 = Math.min(e3, t3);
          let p2 = Math.max(e3, t3);
          if (Math.abs(c2 - p2) === 1) {
            let r4 = e3 + "|" + t3;
            if (u.capture) {
              return `(${r4})`;
          ...
          let f2 = hasPadding(e3) || hasPadding(t3);
          let A = { min: e3, max: t3, a: c2, b: p2 };
          let R = [];
          let _ = [];
          if (f2) {
            A.isPadded = f2;
          ...
          if (c2 < 0) {
            let e4 = p2 < 0 ? Math.abs(p2) : 1;
            _ = splitToPatterns(e4, Math.abs(c2), A, u);
            c2 = A.a = 0;
          }
          if (p2 >= 0) {
            R = splitToPatterns(c2, p2, A, u);
          }
          A.negatives = _;
          A.positives = R;
        ...
        function splitToPatterns(e3, t3, r3, n2) {
          ...
          for (let e4 = 0; e4 < u.length; e4++) {
            ...
            let l = "";
            if (!r3.isPadded && i2 && i2.pattern === a.pattern) {
              if (i2.count.length > 1) {
                i2.count.pop();
              }
              i2.count.push(a.count[0]);
              i2.string = i2.pattern + toQuantifier(i2.count);
              o = t4 + 1;
              continue;
            }
            if (r3.isPadded) {
...
${JSON.stringify(pattern)}`);
    ...
    function hasMatch(domains, remotePatterns, url) {
      return domains.some((domain) => url.hostname === domain) || remotePatterns.some((p2) => matchRemotePattern(p2, url));
    }
  }
});
...
var require_image = __commonJS({
  "../../node_modules/next/dist/client/image.js"(exports, module2) {
    "use strict";
    "use client";
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var _react = _interop_require_wildcard(require("react"));
    var _head = _interop_require_default(require_head());
    var _imageBlurSvg = require_image_blur_svg();
    var _imageConfig = require_image_config();
    var _imageConfigContext = require_image_config_context();
    var _warnOnce = require_warn_once();
    var _imageLoader = _interop_require_default(require_image_loader());
...
Read more: https://nextjs.org/docs/api-reference/next/image#priority`);
      ...
      return /* @__PURE__ */ _react.default.createElement(_react.default.Fragment, null, /* @__PURE__ */ _react.default.createElement(ImageElement, Object.assign({}, imgElementArgs)), priority ? /* @__PURE__ */ _react.default.createElement(_head.default, null, /* @__PURE__ */ _react.default.createElement("link", Object.assign({
    ...
    function generateImgAttrs({ config, src, unoptimized, width, quality, sizes, loader }) {
      ...
      return {
        ...
        srcSet: widths.map((w, i2) => `${loader({
          config,
          src,
          quality,
          width: w
        })} ${kind === "w" ? w : i2 + 1}${kind}`).join(", "),
        src: loader({
          config,
          src,
          quality,
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("a", {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("picture", {
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("svg", {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("g", {
            fill: "#000000",
            "fill-rule": "evenodd",
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("text", {
                ...
                "font-size": "500",
                "font-weight": "500",
                children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("tspan", {
                  x: "993.25",
                  y: "697",
                  className: "",
                  children: "Pylar\u2122 AI"
...
var Navbar = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", {
    className: "sm:hidden",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(motion.div, {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Version, {})
            ]
          })
        ]
      })
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("g", {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("text", {
                ...
                "font-size": "500",
                "font-weight": "500",
                children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("tspan", {
                  x: "993.25",
                  y: "697",
                  className: "underline",
                  children: "Pencil\u2122"
...
var PylarLogo = () => {
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("a", {
      href: "https://pylar.org",
      className: "",
      children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("picture", {
        children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("svg", {
          ...
          viewBox: "0 0 3060 678",
          className: "m-3 h-6 w-24",
          children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("g", {
            fill: "#ffffff",
            "fill-rule": "evenodd",
            transform: "translate(-151 -173)",
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("text", {
                ...
                "font-size": "500",
                "font-weight": "500",
                children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("tspan", {
                  x: "993.25",
                  y: "697",
                  className: "",
                  children: "Pylar\u2122 AI"
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("a", {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("picture", {
        children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("svg", {
          ...
          className: "m-3 h-6 w-24",
          children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("g", {
            fill: "#ffffff",
            "fill-rule": "evenodd",
            transform: "translate(-151 -173)",
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("text", {
                ...
                "font-size": "500",
                "font-weight": "500",
                children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("tspan", {
                  x: "993.25",
                  y: "697",
                  className: "underline",
                  children: "SuperData\u2122"
...
var Supermenu = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", {
    className: "hidden sm:block",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(motion.div, {
        className: "progress-bar",
        style: { scaleX: scrollYProgress }
      }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(PencilLogo, {}),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(PylarLogo, {}),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(SuperdataLogo, {})
        ]
      })
    ]
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", {
        className: "px-1 m-1 box-decoration-slice bg-gradient-to-r from-blue-500 to-blue-500 text-white",
        children: "Mi pagina web"
      }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", {
        className: "px-1 m-1 box-decoration-slice bg-gradient-to-r from-blue-500 to-blue-500 text-white",
        children: "Mi pagina web"
...
var TitlePylar = () => {
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", {
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("a", {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("picture", {
            children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("svg", {
              xmlns: "http://www.w3.org/2000/svg",
              width: "300",
              height: "50",
              viewBox: "0 0 3060 678",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("g", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("text", {
                      ...
                      "font-size": "500",
                      "font-weight": "500",
                      children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("tspan", {
                        x: "993.25",
                        y: "697",
                        children: "Pylar\u2122 AI"
                      })
      ...
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("h1", {
        className: "text-center text-5xl font-bold text-white",
        children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(motion.span, {
          initial: { opacity: 0 },
          animate: { opacity: 1 },
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("p", {
          ...
          children: [
            "Pylar AI is:",
            /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("ul", {
              className: "list-inside list-disc",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("li", {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", {
          className: "m-2 py-8 px-8",
          children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("a", {
            href: "https://www.twitter.com/miguelgargallo/",
            target: "_blank",
            rel: "noreferrer",
            children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_image.default, {
              src: "/twitter.png",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", {
          className: "m-2 py-8 px-8",
          children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("a", {
            href: "https://www.instagram.com/miguelgargallo.es/",
            target: "_blank",
            rel: "noreferrer",
            children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_image.default, {
              src: "/linkedin.png",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", {
          className: "m-2 py-8 px-8",
          children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("a", {
            href: "https://www.twitch.tv/miguelgargallo/",
            target: "_blank",
            rel: "noreferrer",
            children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_image.default, {
              src: "/linkedin.png",
...
var Scrollable = () => {
  const { scrollYProgress } = useScroll();
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(motion.div, {
    className: "progress-bar",
    style: { scaleX: scrollYProgress }
  });
};
...
var blog = () => {
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", {
    children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      width: "95",
      height: "95",
      stroke: "#FFF",
...
var Contact = () => {
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", {
    className: "pylarDiv",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(motion.button, {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", {
            className: "pylarDiv",
            children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(motion.button, {
